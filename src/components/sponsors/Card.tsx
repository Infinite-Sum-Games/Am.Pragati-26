...
const Card = (props: {
  ...
  return (
    <motion.div
      ...
      className="scale-70 w-100 h-59 object-cover relative bg-[url(sponsors-page/card.png)] bg-cover bg-no-repeat flex flex-col pb-5 gap-1 justify-center items-center"
    >
