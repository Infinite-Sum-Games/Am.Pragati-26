  ...
  return (
    ...
    >
      <div className="flex flex-col gap-1.5">
        <Label htmlFor="email" className="font-medium text-sm text-white text-[10px]" style={pixelFont}>
          EMAIL
        </Label>
        <Input
          id="email"
        ...
        />
        {errors.email && (
          <p className="text-red-500 text-[8px]" style={pixelFont}>{errors.email.message}</p>
        )}
      </div>
      <div className="flex flex-col gap-1.5">
        <Label htmlFor="password" className="font-medium text-sm text-white text-[10px]" style={pixelFont}>
          NEW PASSWORD
        </Label>
        ...
        {errors.password && (
          <p className="text-red-500 text-[8px]" style={pixelFont}>{errors.password.message}</p>
        )}
      </div>
      <div className="flex flex-col gap-1.5">
        <Label htmlFor="confirmPassword" className="font-medium text-sm text-white text-[10px]" style={pixelFont}>
