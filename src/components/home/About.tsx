	...
	return (
      ...
      `}</style>
			...
			<div className="sticky top-0 w-screen h-screen overflow-hidden flex items-center justify-center">
				<section className="relative w-full h-full bg-black bg-[url(about/bg.webp)] bg-cover bg-no-repeat bg-center">
					<motion.div
						className="absolute bottom-0 left-1/2 -translate-x-1/2 w-75 md:w-100 lg:w-275 origin-center z-10"
					...
					>
						...
						<div className="absolute top-[12%] left-[15%] w-[70%] h-[40%] flex items-center justify-center">
							<span className="text-white text-2xl md:text-3xl lg:text-6xl font-bold tracking-wider font-jersey15 shadow-black text-shadow-lg">
								About Us
							</span>
						</div>
					</motion.div>
